...
import tagendRouter from './modules/tagend'
    ...
    children: [
      {
        ...
        name: '用户管理',
        meta: { title: '用户管理', icon: 'peoples', noCache: true, roles: ['admin', 'role_admin'] }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '权限管理',
        meta: { title: '权限管理', icon: 'lock', noCache: true, roles: ['admin', 'role_admin'] }
      }
    ]
  },
  // store1Router,
